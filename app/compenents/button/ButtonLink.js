...
const ButtonLink = ({ href, title, dark }) => {
    ...
    return (
        <Link onMouseOver={() => setOver(true)} onMouseLeave={() => setOver(false)} href={href} className='relative flex items-center justify-center px-4 py-2 text-xs rounded-full md:px-8 md:text-lg cursor pointer font-mori' >
