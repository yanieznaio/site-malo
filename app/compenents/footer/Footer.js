        ...
        <footer className='relative bottom-0 flex flex-col pt-40 pb-8 md:pb-[8vh] bg-dark-brown text-light-brown  '>
            <div className='flex flex-col-reverse border-b md:flex-row border-light-brown'>
                <ul className='md:w-4/5 text-4xl md:text-[4vw]  font-playfair  flex flex-col '>
                    <motion.div whileInView={{ width: '100%' }} initial={{ width: 0 }} transition={{ type: 'ease', duration: 0.3 }} className='h-px bg-light-brown'></motion.div>
                    ...
                    <li><motion.div whileInView={{ width: '100%' }} initial={{ width: 0 }} transition={{ type: 'ease', duration: 0.3 }} className='h-px bg-light-brown'></motion.div></li>
                ...
                <div className="relative flex flex-col justify-between border-top-0 md:w-1/5 ">
                    <motion.div whileInView={{ height: '100%' }} initial={{ height: 0 }} transition={{ type: 'ease', duration: 0.3 }} className='absolute hidden w-px md:block bg-light-brown'></motion.div>
                    <motion.div whileInView={{ width: '100%' }} initial={{ width: 0 }} transition={{ type: 'ease', duration: 0.3 }} className='hidden h-px md:block bg-light-brown'></motion.div>
            ...
            <motion.h1 initial={{ scale: 0.9 }} whileInView={{ scale: 1 }} transition={{ type: 'tween' }} className='text-[8.2vw] mt-10 font-bold  bg-dark-brown'>COTÉ ENVIRONNEMENT</motion.h1>
