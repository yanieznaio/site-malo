...
const Slider = () => {
    ...
    return (
        <div className='flex flex-col items-center justify-center w-full min-h-screen overflow-hidden md:gap-10 bg-dark-brown text-light-brown md:pt-20 md:pb-40'>
