...
const HeroBox = () => {
    return (
        <div className='absolute flex flex-col  md:w-[32vw] max-w-[483px] min-w-[350px] max-h-[450px] md:max-h-[650px] gap-8  p-4 backdrop-filter bg-light-brown backdrop-blur-xl bg-opacity-10  h-[70vh] md:h-[85vh] mt-12 '>
            ...
            <div className='text-center text-white'>
                ...
                <p className='w-4/5 m-auto text-sm md:text-lg opacity-50 font-mori md:leading-[19px]'>Votre guide vers un bâtiment zéro carbone </p>
