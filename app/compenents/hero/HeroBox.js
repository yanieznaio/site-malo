...
const HeroBox = () => {
    return (
        <motion.div className=' absolute flex flex-col md:w-[30vw] max-w-[483px] min-w-[350px]  max-h-[500px] md:max-h-[650px] gap-8  p-4 backdrop-filter bg-light-brown backdrop-blur-xl bg-opacity-10  md:bg-opacity-25 h-[75vh] md:h-[85vh] mt-12 '>
