                ...
                <div className="container relative px-4 mx-auto">
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="py-12 border-t-2 border-gray-100">
                            <div className="flex flex-wrap items-center lg:flex-nowrap">
                                <div className="w-full px-4 mb-8 lg:w-auto lg:mb-0">
                                    <img className="block w-44 h-30" src="nature.jpg" alt="" />
                                </div>
                        ...
                        <div className="pt-12 text-center border-t-2 border-gray-100">
                            <a className="relative inline-block py-4 overflow-hidden font-semibold transition duration-300 rounded-full text-light-brown group px-7 hover:text-orange-50 bg-dark-brown" href="#">
                                ...
                                <span className="relative">voir plus d'Articles</span>
                            </a>
                        </div>
                    </div>
                </div>
